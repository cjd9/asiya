					   ...
					   <br /><br />
                        ...
                        <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title"><b>Festival</b></h4>
                            </div><!-- panel-heading -->
                           <br />
                            ...
                            <div class="table-responsive">
								<table id="basicTable" class="table table-striped table-bordered">
									...
									<tbody>
									<?php $unique=array(); $cnt = 0; foreach($rsfestival->result() as $row) : ?>
									<?php if(!in_array($row->festival_id,$unique)){ $unique[] =$row->festival_id ; ?>
										<tr>
											...
											<td>
												<div align="center">
													<a href="<?php print base_url(); ?>festival/view/<?php echo $row->festival_id; ?>" class="btn btn-success btn-sm mr5" >
														<i class="fa fa-search"></i> View
													</a>

													<a href="<?php print base_url(); ?>festival/edit/<?php echo $row->festival_id; ?>" class="btn btn-info btn-sm">
														<i class="fa fa-edit"></i> Edit
													</a>

													<button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal_delete" onclick="delete_1('<?php echo $row->festival_id; ?>')">
