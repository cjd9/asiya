							...
							<div class="col-md-12">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="row">
											<?php
												$sql = "SELECT activity_id FROM activity_program ORDER BY activity_id DESC LIMIT 1";
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<div class="input-group">
														<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
														<input type="text" class="form-control validate[required] datepicker" name="expiry_date" placeholder="dd-mm-yyyy" id="expiry_date">
													</div><!-- input-group -->
												</div>
											</div><!-- form-group -->
											...
											<div class="form-group">
												...
												<label class="col-md-2 control-label">File<span class="asterisk">*</span></label>
													<div class="col-sm-8" id="file_upload">
														<input type="file" id="activity_program_file" name="activity_program_file[]" class="validate[required]"/>
													</div>
													<div class="col-sm-2"> 
