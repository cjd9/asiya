					...
					<div class="contentpanel contentpanel-wizard">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- BASIC WIZARD -->
                                <form method="post" action="<?php echo $saveaction; ?>" id="valWizard" class="panel-wizard" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-pane" id="tab1-4"><!-- Start tab-pane -->
                                           ...
                                           <div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_present_complaint" id="p_present_complaint"></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_past_history" id="p_past_history"></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_aggrevating_factor" id="p_aggrevating_factor"></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_relieving_factor" id="p_relieving_factor"></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												...
												<div class="col-sm-6">	
													...
													<div class="col-sm-3">
														<div class="col-sm-9">
															<input type="text" name="p_height" class="form-control validate[required]" id="p_height"/>
														</div>
														<div class="col-sm-1">
															Ft-In
														</div>
													...
													<label class="col-sm-1"><b>Weight</b></label><div class="col-sm-3">
														<div class="col-sm-9">
															<input type="text" name="p_weight" class="form-control validate[required]" id="p_weight" />
														</div>
														<div class="col-sm-1">
															KG
														</div>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_allergies" id="p_allergies" /></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_recent_surgery_done" id="p_recent_surgery_done"></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control validate[required]" rows="1" name="p_current_medication" id="p_current_medication"></textarea>
													</div>
                                            	</div>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-2">
														<input type="text" name="p_daily_water_intake" id="p_daily_water_intake" class="form-control validate[required]" />
													</div>
                                            	</div>
										...
										<div class="tab-pane" id="tab3-4"><!--Start tab-pane -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-12">
													<label class="col-sm-2"></label>
													<div class="col-sm-10">
														<textarea class="form-control validate[required]" rows="2" name="blood_observation" id="blood_observation" ></textarea>
													</div>
												</div>
											</div><!-- End form-group -->
