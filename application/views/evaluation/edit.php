					...
					<div class="contentpanel contentpanel-wizard">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- BASIC WIZARD -->
                                <form method="post" action="<?php echo $editaction; ?>" id="valWizard" class="panel-wizard" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-pane" id="tab1-4"><!-- Start tab-pane -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<b>: <?php $r1 = $this->db->get_where('contact_list', array('patient_id' => $r->patient_id))->row(); echo $r1->p_fname.' '.$r1->p_lname; ?></b> <input type="hidden" name="patient_id" id="patient_id" value="<?php echo $r->patient_id; ?>" />
													</div>
                                            	</div>
                                            </div><!-- End form-group -->
                                           	...
                                           	<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_present_complaint" id="p_present_complaint"><?php echo $r->p_present_complaint; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_past_history" id="p_past_history"><?php echo $r->p_past_history; ?></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_aggrevating_factor" id="p_aggrevating_factor"><?php echo $r->p_aggrevating_factor; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_relieving_factor" id="p_relieving_factor"><?php echo $r->p_relieving_factor; ?></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-1">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault" type="checkbox" name="p_other_chkbox" <?php if($r->p_other_chkbox== 1) { echo ' checked="checked"'; } ?> value="1">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-4">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault1"  type="checkbox" name="p_hyper_tension" <?php if($r->p_hyper_tension== 1) { echo 'checked="checked"'; } ?> value="1">
															<label for="checkboxDefault1"><b>Hyper Tension</b></label>
														</div>
													</div>
													<div class="col-sm-3">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault2" type="checkbox" name="p_diabetes" <?php if($r->p_diabetes== 1) { echo 'checked="checked"'; } ?> value="1">
												...
												<div class="col-sm-6">	
													...
													<div class="col-sm-3">
														<div class="col-sm-9">
															<input type="text" name="p_height" class="form-control" id="p_height" value="<?php echo $r->p_height;?>"/>
														</div>
														<div class="col-sm-1">
															Ft-In
														</div>
													...
													<label class="col-sm-1"><b>Weight</b></label><div class="col-sm-3">
														<div class="col-sm-9">
															<input type="text" name="p_weight" class="form-control" id="p_weight" value="<?php echo $r->p_weight; ?>" />
														</div>
														<div class="col-sm-1">
															KG
														</div>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_allergies" id="p_allergies" /><?php echo $r->p_allergies; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_recent_surgery_done" id="p_recent_surgery_done"><?php echo $r->p_recent_surgery_done; ?></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_current_medication" id="p_current_medication"><?php echo $r->p_current_medication; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													<label class="col-sm-4">Others</label>
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_other_medical_history" id="p_other_medical_history"><?php echo $r->p_other_medical_history; ?></textarea>
													</div>
                                            	</div>
												<div class="col-sm-6">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-2">
														<input type="text" name="p_daily_water_intake" id="p_daily_water_intake" class="form-control" value="<?php echo $r->p_daily_water_intake; ?>" />
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-3">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault3" type="checkbox" name="p_diet_veg" <?php if($r->p_diet_veg== 1) { echo 'checked="checked"'; } ?> value="1">
													...
													<div class="col-sm-3">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault4" type="checkbox" name="p_diet_nonveg" <?php if($r->p_diet_nonveg== 1) { echo 'checked="checked"'; } ?> value="1">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_other_general"><?php echo $r->p_other_general; ?></textarea>
													</div>
                                            	</div>
												<div class="col-sm-6">
                                        ...
                                        <div class="tab-pane" id="tab2-4">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault6" type="checkbox" name="p_cigarettes" <?php if($r->p_cigarettes == 1) { echo ' checked="checked"'; } ?> value="1">
												...
												<div class="col-sm-4" id="cigarettes_daily_intake">
													...
													<div class="col-sm-3">
														<input type="text" name="cigarettes_daily_intake" id="cigarettes_daily_intake" class="form-control" value="<?php echo $r->cigarettes_daily_intake;?>" />
													</div>
                                            	</div>
												...
												<div class="col-sm-4" id="cigarettes_addiction_since">
													...
													<div class="col-sm-3">
														<input type="text" name="cigarettes_addiction_since" id="cigarettes_addiction_since" class="form-control" value="<?php echo $r->cigarettes_addiction_since;?>" />
													</div>
                                            	</div>
												<?php } else { ?>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault7" type="checkbox" name="p_alcohol" <?php if($r->p_alcohol == 1) { echo 'checked="checked"'; } ?> value="1">
												...
												<div class="col-sm-4" id="alcohol_daily_intake">
													<label class="col-sm-6">Daily Intake Count</label>
													<div class="col-sm-3">
														<input type="text" name="alcohol_daily_intake" id="alcohol_daily_intake" class="form-control" value="<?php echo $r->alcohol_daily_intake; ?>" />
													</div>
                                            	</div>
												<div class="col-sm-4" id="alcohol_addiction_since">
													<label class="col-sm-7">Addiction Since(in Months)</label>
													<div class="col-sm-3">
														<input type="text" name="alcohol_addiction_since" id="alcohol_addiction_since" class="form-control" value="<?php echo $r->alcohol_addiction_since; ?>" />
													</div>
                                            	</div>
												<?php } else { ?>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault8" type="checkbox" name="p_tobaco" <?php if($r->p_tobaco == 1) { echo 'checked="checked"'; } ?> value="1">
												...
												<div class="col-sm-4">
													<label class="col-sm-6">Daily Intake Count</label>
													<div class="col-sm-3">
														<input type="text" name="tobaco_daily_intake" id="tobaco_daily_intake" class="form-control" value="<?php echo $r->tobaco_daily_intake; ?>" />
													</div>
                                            	</div>
												<div class="col-sm-4">
													<label class="col-sm-7">Addiction Since(in Months)</label>
													<div class="col-sm-3">
														<input type="text" name="tobaco_addiction_since" id="tobaco_addiction_since" class="form-control" value="<?php echo $r->tobaco_addiction_since; ?>" />
													</div>
                                            	</div>
												<?php } else { ?>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-4">
													...
													<div class="col-sm-4">
														<div class="ckbox ckbox-default">
															<input id="checkboxDefault9" type="checkbox" name="p_none"  <?php if($r->p_none == 1) { echo 'checked="checked"'; } ?> value="1">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<input type="text" name="p_vitamin" id="p_vitamin" class="form-control"  value="<?php echo $r->p_vitamin; ?>"/>
													</div>
                                            	</div>
										...
										<div class="tab-pane" id="tab3-4"><!--Start tab-pane -->
											...
											<div class="form-group"><!-- Start form-group -->
												...
												<div class="col-sm-6">
													<label class="col-sm-4">Others</label>
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="blood_investigation_other"><?php echo $r->blood_investigation_other; ?></textarea>
													</div>
                                            	</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-12">
													<label class="col-sm-2"></label>
													<div class="col-sm-10">
														<textarea class="form-control validate[required]" rows="2" name="blood_observation"><?php echo $r->blood_observation; ?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_special_test" id="p_special_test"><?php echo $r->p_special_test; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_range" id="p_range"><?php echo $r->p_range; ?></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_quality" id="p_quality"><?php echo $r->p_quality; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_combined_movement" id="p_combined_movement">
                                            ...
                                            <div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_movement_notes" id="p_movement_notes">
                                        ...
                                        <div class="tab-pane" id="tab4-4">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_strength" id="p_strength"><?php echo $r->p_strength; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_flexibility" id="p_flexibility"><?php echo $r->p_flexibility; ?></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													<label class="col-sm-4">Notes</label>
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_muscle_notes" id="p_muscle_notes"><?php echo $r->p_muscle_notes; ?></textarea>
													</div>
                                            	</div>
                                            </div><!-- End form-group -->
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_tenderness" id="p_tenderness"><?php echo $r->p_tenderness; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_swelling" id="p_swelling"><?php echo $r->p_swelling; ?></textarea>
													</div>
												</div>
                                            </div><!-- End form-group -->
										   ...
										   <div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_limblength" id="p_limblength"><?php echo $r->p_limblength; ?></textarea>
													</div>
                                            	</div>
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="nueral_investigation" id="nueral_investigation">
											...
											<div class="form-group"><!-- Start form-group -->
												<div class="col-sm-6">
													<label class="col-sm-4">Notes</label>
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="p_palpation_notes" id="p_palpation_notes">
												...
												<div class="col-sm-6">
													...
													<div class="col-sm-8">
														<textarea class="form-control" rows="1" name="provisional_diagnosis" id="provisional_diagnosis">
