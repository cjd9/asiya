	...
	<?php $this->load->view('include/left'); ?>
                ...
                <div class="mainpanel">
                   ...
                   <div class="contentpanel">
                      	 <a href="<?php print base_url(); ?>index.php/evaluation/add">
					  	 	<button class="btn btn-primary"><i class="fa fa-pencil"></i> Add Evaluation</button>
						 </a>
					   <br /><br />
								...
								<table id="basicTable" class="table table-striped table-bordered">
									...
									<?php $cnt = 0; foreach($rsevaluation->result() as $row) : ?>
									   <tr>
											...
											<td>
											   <div align="center"><a href="<?php print base_url(); ?>index.php/evaluation/view/<?php echo $row->pk; ?>" class="btn btn-success btn-sm mr5" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-search"></i> View
												 </a>
												 
												  <a href="<?php print base_url(); ?>index.php/evaluation/print_evaluation_form/<?php echo $row->patient_id; ?>/<?php echo $row->pk; ?>" class="btn btn-primary btn-sm">
													<i class="fa fa-print"></i> Print									         
												</a>
												 
												<a href="<?php print base_url(); ?>index.php/evaluation/edit/<?php echo $row->pk; ?>"class="btn btn-info btn-sm">
