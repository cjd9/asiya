<?php $this->load->view('include/header'); ?>
					   ...
					   <br /><br />
                        ...
                        <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title"><b>Email</b></h4>
                            </div><!-- panel-heading -->
                           <br />
							...
							<table id="basicTable" class="table table-striped table-bordered">
                                ...
                                <tbody>
								<?php $cnt = 0; foreach($rsemail->result() as $row) : ?>
								   <tr>
										...
										<td><?php echo date("d-m-Y h:i:s A", strtotime($row->sent_on)); ?></td>
                                        ...
                                        <td>
											<div align="center">
												...
												<button class="btn btn-info btn-sm" onclick="resend_email(<?php echo $row->pk; ?>)">
	...
	<?php $this->load->view('include/footer'); ?>
	 ...
	 <script>
	 	// function to resen email to patient -
		function resend_email(id)
		{
			var res = confirm("You want to Re-Send Email to this Patient?");
				...
				$.ajax({
						...
						success: function (res) 
						{
							...
							if(res)
							{
								...
								$("#email_sent_msg p").text('Email Re-Sent Successfully.');
							...
							{	
								...
								$("#email_sent_msg p").text('Email Re-Sent Error.');
