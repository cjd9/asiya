							...
							<div class="col-md-12">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										...
										<h3 class="panel-title"><i class="glyphicon glyphicon-envelope"></i> <b>Forward Email </b></h3>
									</div><!-- panel-heading -->
									...
									<div class="panel-body">
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="ckbox ckbox-default">
														<input value="1" id="checkboxDefault" type="checkbox" name="is_cc" <?php if($row->is_cc == 1) { ?> checked="checked"<?php } ?>>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" name="email_subject" id="email_subject" class="form-control validate[required]" placeholder="Enter email subject" value="<?php echo $row->sub; ?>" readonly>
												</div>
											</div><!-- form-group -->
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<textarea id="wysiwyg" name="msg" placeholder="Enter text here..." class="form-control validate[required]" rows="10" readonly="readonly"><?php echo $row->msg; ?></textarea>
												</div>
											</div><!-- form-group -->
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="hidden" id="attachment_file_name" name="attachment_file_name" class="form-control" value="<?php echo $row->attachment_file_name; ?>" />
													<div><a href="<?php echo base_url().'email_attachment_file/'.$row->attachment_file_name; ?>" target="_blank"> <?php echo $row->attachment_file_name; ?> </a></div>
												</div>
											</div><!-- form-group -->
	...
	<script>
		$(document).ready(function()
		{
			...
			$('#send_email_form').on('submit', function(e) 
			{
				...
				m_data.append( 'attachment_file_name', $('input[name=attachment_file_name]').val());
