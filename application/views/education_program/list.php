	...
	<?php $this->load->view('include/left'); ?>
                ...
                <div class="mainpanel">
                   ...
                   <div class="contentpanel">
                      	 <a href="<?php print base_url(); ?>index.php/education_program/add">
								...
								<table id="basicTable" class="table table-striped table-bordered">
									...
									<?php $cnt = 0; foreach($rseducation_program->result() as $row) : ?>
										<tr>
											...
											<td>
												<div align="center">
													<a href="<?php print base_url(); ?>index.php/education_program/comment_box/<?php echo $row->pk; ?>"  class="btn btn-sm btn-bordered btn-default" data-toggle="modal" data-target=".bs-example-modal-lg">
											...
											<td>
												<div align="center">
													<a href="<?php print base_url(); ?>index.php/education_program/edit/<?php echo $row->pk; ?>" class="btn btn-info btn-sm">
														<i class="fa fa-edit"></i> Edit									        
													</a>
													
													<a href="<?php print base_url(); ?>index.php/education_program/sms/<?php echo $row->pk; ?>" class="btn btn-success btn-sm">
														<i class="glyphicon glyphicon-phone"></i> SMS									        
													</a>
													
													<a href="<?php print base_url(); ?>index.php/education_program/email/<?php echo $row->pk; ?>" class="btn btn-primary btn-sm">
