									...
									<div class="panel-body">
										<div class="row">
											...
											<div class="form-group">
												<label class="col-md-3 control-label"> Description<span class="asterisk">*</span></label>
												<div class="col-sm-9">
													<textarea rows="2" name="education_program_desc" id="education_program_desc" class="form-control validate[required]"></textarea>
												</div>
											</div><!-- form-group -->
											
											<div class="form-group">
												<label class="col-md-3 control-label"> File<span class="asterisk">*</span></label>
												<div class="col-sm-6">
