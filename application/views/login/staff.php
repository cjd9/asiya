...
<html lang="en">
    <head>
        ...
        <title> :: Clinic Management System - Staff Login :: </title>
				...
				<div class="panel panel-signin">
					<div class="panel-body">
						<div class="logo text-center" style="margin-top:-110px">
							...
							<h3><b><span class="fa fa-user-md"></span> STAFF LOGIN</b></h3>
						</div>
						...
						<form action="<?php echo base_url().'index.php/login/validatelogin'; ?>" method="post">
